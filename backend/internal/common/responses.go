...
const (
	...
	ResponseFailedToAddFavoriteRecipe      = "failed_to_add_favorite_recipe"
	ResponseFailedToRemoveFavoriteRecipe   = "failed_to_remove_favorite_recipe"
	ResponseFailedToRetriveFavoriteRecipes = "failed_to_remove_favorite_recipe"
)
